        ...
        <div class="register_card">
            ...
            <form action="register.php" method="POST" class="register_form">
                ...
                <div class="input" style="position:relative;">
                    ...
                    <input type="text" name="contact" placeholder="contact" style="padding-left:3.2rem;" value="<?php echo isset($contact) ? htmlspecialchars($contact) : ''; ?>"  maxlength="10" required>
                </div>
                <div class="form_row">
                    <div class="input">
